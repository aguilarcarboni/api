    ...
    class Brain:
        ...
        def ask(self, messages):
            ...
            if result['tool_calls'] is not None:
                ...
                functionResult = self.executeFunctionCall(tool_call)
                result = {"role": "function", "name": tool_call['function']['name'], "content": str(functionResult)}
        ...
        def executeFunctionCall(self, tool_call):

            print('Running function:\n', tool_call)

            if tool_call['function']['name'] == "get_info_from_database":
                
                # TODO add functionality for context by adding database schemas then popping them from memory
                result = 'Andres'
                print(result)
